...
public class PerfilDePlanDeSoporte extends javax.swing.JPanel {
    ...
    public void setAgregarTareaEnabled(boolean in){
        jButton3.setEnabled(in);
    }
    
    public void setQuitarTareaEnabled(boolean in){
        jButton4.setEnabled(in);
    }
    
    public void setAgregarPoliticasEnabled(boolean in){
        jButton1.setEnabled(in);
    }
    
    public void setQuitarPoliticasEnabled(boolean in){
    ...
    private void jTextField1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField1FocusLost
        if(!nombreAntiguo.equals(jTextField1.getText())){
            int i = JOptionPane.showConfirmDialog(frame, "Seguro que quieres cambiar costo modificacion: "+nombreAntiguo+
                "\npor "+jTextField1.getText());
            if(i==0){
                for (int j = 0; j < EntityDB.getInstance().getPlanesDeSoporte().size(); j++) {
                    if(((PlanDeSoporte)EntityDB.getInstance().getPlanesDeSoporte().get(j)).getNombre().equals(nombreAntiguo)){
                        ((PlanDeSoporte)EntityDB.getInstance().getPlanesDeSoporte().get(j)).setNombre(jTextField1.getText());
                    }
                }
            }
            nombreAntiguo = jTextField1.getText();
    ...
    private void jTextArea1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextArea1FocusGained
        descripcionAntigua = jTextArea1.getText();
    }//GEN-LAST:event_jTextArea1FocusGained

    private void jTextArea1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextArea1FocusLost
        if(!descripcionAntigua.equals(jTextArea1.getText())){
            int i = JOptionPane.showConfirmDialog(frame, "Seguro que quieres cambiar costo modificacion: "+descripcionAntigua+
                "\npor "+jTextArea1.getText());
            if(i==0){
                for (int j = 0; j < EntityDB.getInstance().getPlanesDeSoporte().size(); j++) {
                    if(((PlanDeSoporte)EntityDB.getInstance().getPlanesDeSoporte().get(j)).getNombre().equals(jTextField1.getText())){
                        ((PlanDeSoporte)EntityDB.getInstance().getPlanesDeSoporte().get(j)).setDescripcion(jTextArea1.getText());
                    }
                }
            }
            descripcionAntigua = jTextArea1.getText();
