 ...
 * @author Itzcoatl90
 */
public class PerfilDePlanDeSoporte extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Plan de Soporte");

        jLabel2.setText("Nombre");

        jTextField1.setEditable(false);
        jTextField1.setText("Plan de contingencia");
        ...
        jLabel4.setText("Politicas que soporta");
        ...
        jLabel5.setText("Tiempo de Monitoreo");

        jTextField2.setEditable(false);
        jTextField2.setText("30 dias");

        jLabel6.setText("Proximo Monitoreo");

        jTextField3.setEditable(false);
        jTextField3.setText("25/4/2013");
